...
from GazeNet import GazeNetReg, GazeNetReg2, GazeNetRegVgg, GazeNetRegLSTM
...
#    dataset_train = MirkoDatasetReg(root_dir = ['training2/', 'training3/', 'test1/'],
    # NORMALIZATION
    dataset_train = MirkoDatasetRegNormRam(root_dir = [root_dataset + 'train_nino_hs/'],
                                        transform = data_transforms_custom1,
                                        dset_type='train', seed=seed, 
                                        training_per = [0.8],
                                        permuted= False)
    dataset_test = MirkoDatasetRegNormRam(root_dir = [root_dataset + 'train_nino_hs/'],
...
#        criterion = nn.CrossEntropyLoss()
    ...
    dataset_test = MirkoDatasetRegNorm(root_dir = [root_dataset + 'train_nino_hs/',
                                                   root_dataset + 'test_nino_hs/'],
                                       transform = data_transforms_custom2,
                                       dset_type='val', seed=seed,
                                       training_per = [0.0, 0.0], permuted = False)
