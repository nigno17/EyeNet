...
from GazeNet import GazeNetReg, GazeNetReg2, GazeNetRegVgg, GazeNetRegMeanVar
...
train = True
restore = False
checkpoint_dir = '/media/nigno/Data/checkpointsMirkoNoRandom/'
...
for trials in range(N_trials):
    ...
    root_dataset = '/media/nigno/Data/simDatasetNetNoRandom/'
    root_dataset_test = ''
